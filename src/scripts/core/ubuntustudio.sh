...
sudo chattr -i /etc/profile.d/ubuntustudio-pwjack.sh
...
wget -q --show-progress -O "$HOME"/.config/rncbc.org/QjackCtl.conf https://github.com/estudio-debian/estudio-debian.github.io/raw/main/src/settings/audio/jack/QjackCtl.conf
mkdir -p "$HOME"/.config/pipewire/pipewire.conf.d
export QOPT=128
export ROPT=44100
curl -sSL https://github.com/estudio-debian/estudio-debian.github.io/raw/main/src/settings/audio/pipewire/99-custom.conf | envsubst | tee "$HOME"/.config/pipewire/pipewire.conf.d/99-custom.conf >/dev/null
systemctl --user restart pipewire pipewire-pulse
sudo mkdir -p /usr/local/{bin,share/applications}
sudo wget -q --show-progress -O /usr/local/bin/pipewire-latency-switcher https://github.com/estudio-debian/estudio-debian.github.io/raw/main/src/settings/audio/pipewire/pipewire-latency-switcher
sudo chmod +x /usr/local/bin/pipewire-latency-switcher
sudo wget -q --show-progress -O /usr/local/share/applications/pipewire-latency-switcher.desktop https://github.com/estudio-debian/estudio-debian.github.io/raw/main/src/settings/audio/pipewire/pipewire-latency-switcher.desktop
...
sudo wget -q --show-progress -O /usr/local/bin/toggle-pipewire-jack https://github.com/estudio-debian/estudio-debian.github.io/raw/main/src/settings/audio/pipewire/toggle-pipewire-jack
